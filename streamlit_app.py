...
# --- ROW 1 ---
st.write("# Employee Demografi Dashboard")
st.write('''The dashboard's intuitive interface and comprehensive data visualizations provide a clear and
          concise overview of your workforce's demographics. Easily track hiring trends over time,
         identify geographical distribution patterns, and uncover generational and gender insights across
          departments.''')
...
col1.plotly_chart(plot_join, use_cointainer_width=True)
...
col2.plotly_chart(plot_map, use_cointainer_width=True)
